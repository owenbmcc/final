   ...
   */
        ...
        var reallog = false;
            ...
            if (this.liquidAlien.overlap(this.character)) {
                /* style dialog */
                console.log(this.liquidAlien.dialogCount);
                textSize(20);
                ...
                if (this.liquidAlien.dialogCount == 0) {
                    ...
                    //dialog = "hello, do you have something I can use to get out of here? I need help."
                ...
                if (blackhole == false && this.liquidAlien.dialogCount == 6.5) {
                    ...
                    if (this.liquidAlien.dialogCount == 7) {
                        ...
                        humanDialog = "choice [1]: heres the blackhole.choice [2]: *throw blackhole into alien and freeze her* choice [3]: heres a pet. press [4]: not yet"
                        if (keyIsDown(1)) {
                            ...
                            if (this.liquidAlien.dialogCount == 9) {
                                ...
                                if (knife == true) {
                                    ...
                                    humanDialog = "You break off pieces with key and the map"
                    ...
                    if (this.creepAlien.overlap(this.character)) {
                        /* style dialog */
                        console.log(this.creepAlien.dialogCount);
                        textSize(20);
                        fill('red');
                        stroke('black');
                        strokeWeight(1);
                    ...
                    if (this.cosmicAlien.overlap(this.character)) {
                        /* style dialog */
                        console.log(this.cosmicAlien.dialogCount);
                        textSize(20);
                        ...
                        if (this.cosmicAlien.dialogCount == 0) {
                            ...
                            if (blackholeneed = false) {
                                humanDialog = "Do you have any of those? "
                                if (this.cosmicAlien.dialogCount == 3) {
                                    ...
                                    humanDialog = "Thanks, I don't really know how I got here. I'll come back when I have one."
                                }
                            }
                            if (fakelog == true) {
