class marsii extends Scene {
    ...
    preload() {
        ...
        */
        ...
        this.cosmicAlien = new NPC(50, 1100, cosmicAlienSheet, "Hi. you need me for my power.");
        ...
        */
        ...
        if (this.staticAlien.overlap(this.character)) {
            ...
            if (this.staticAlien.dialogCount == 0) {
                ...
                text(humanDialogS, this.character.x, this.character.y);
                fill(255);
            ...
            if (this.cosmicAlien.overlap(this.character)) {
                ...
                if (this.cosmicAlien.dialogCount == 25) {
                    dialog = "She's grateful and has nothing more to say to you"
                }
                ...
                text(humanDialogC, this.character.x, this.character.y);
                fill(255);
